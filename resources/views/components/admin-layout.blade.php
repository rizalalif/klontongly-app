...
<body>
    <main class="ml-10">
        <div class="antialiased bg-gray-50 dark:bg-gray-900">
            <nav class="bg-prima border-gray-200 px-4 py-2.5 bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
                <div class="flex flex-wrap justify-between items-center">
                    ...
                    <div class="flex items-center lg:order-2">
                        ...
                        <!-- Dropdown menu -->
                        <div class="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded-xl divide-y divide-gray-100 shadow-lg dark:divide-gray-600 dark:bg-gray-700 rounded-xl" id="notification-dropdown">
                        ...
                        <div class="hidden z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 rounded-xl" id="dropdown">
                            ...
                            <ul class="py-1 text-gray-700 dark:text-gray-300" aria-labelledby="dropdown">
                                ...
                                <li>
                                    <a href="/" class="block py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-white">User Dashboard</a>
                                </li>
                            </ul>
                            <ul class="py-1 text-gray-700 dark:text-gray-300" aria-labelledby="dropdown">
                                <li>
            ...
            <aside class="fixed top-0 left-0 z-40 w-64 h-screen pt-14 transition-transform -translate-x-full bg-gray-800 border-r border-gray-200 md:translate-x-0" aria-label="Sidenav" id="drawer-navigation">
                <div class="overflow-y-auto py-5 px-3 h-full bg-blue">
                    ...
                    <ul class="space-y-2">
                        <li>
                            <a href="#" class="flex items-center p-2 text-white font-medium rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
