  ...
  <div class="container grid md:grid-cols-4 grid-cols-2 gap-6 pt-4 pb-16 items-start">
    ...
    <!-- <div id="drawer-example" class="fixed top-0 left-0 z-40 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white w-80 dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-label">
      ...
      <div class="grid grid-cols-2 gap-4">
        ...
        <a href="#" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Get access
    ...
    <div class="col-span-3">
      ...
      <div class="grid md:grid-cols-3 grid-cols-2 gap-6">
        ...
        <div class="bg-white shadow rounded overflow-hidden group ">
          <div class="relative">
            <img src="{{ asset('assets/images/products/' . $product->image) }}" alt="product 1" class="w-full" />
            <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition z-40">
          ...
          <div class="pt-4 pb-3 px-4">
            ...
            <div class="flex items-center">
              ...
              <div class="text-xs text-gray-500 ml-3">({{$product->stok}})</div>
            </div>
          </div>

          <div class="flex flex-row gap-1 px-1 my-1">

            <a href="#" class="block w-1/4 py-1 pl-7 text-white bg-primary border border-primary rounded hover:bg-transparent hover:text-primary transition">
              <svg class="w-7 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122.88 104.42">
            ...
            <a href="#" class="block w-3/4 py-1 text-center text-white bg-primary border border-primary rounded hover:bg-transparent hover:text-primary transition">Buy Now</a>
          </div>
        </div>
        @endforeach
      </div>
